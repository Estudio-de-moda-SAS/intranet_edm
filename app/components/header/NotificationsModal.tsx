    ...
    <AnimatePresence>
      {open && (
        <motion.div
          ...
          className="w-[calc(100vw-2rem)] max-w-[22rem] rounded-2xl overflow-hidden z-[9999]
                     border shadow-xl
        ...
        >
                      ...
                      <div className="flex items-start justify-between gap-2">
                        ...
                        <button
                          ...
                          className="opacity-0 group-hover:opacity-100 transition-opacity shrink-0 rounded p-0.5
                                     ...
                                     dark:hover:bg-[#30363d] dark:text-[#545d68]"
                        >
          ...
          {/* Footer */}
          <div className="px-4 py-2.5 border-t border-slate-100 dark:border-[#21262d]">
            <a
              href="/notificaciones"
              onClick={onClose}
