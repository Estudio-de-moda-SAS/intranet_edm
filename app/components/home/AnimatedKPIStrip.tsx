...
"use client";
import { LayoutGrid, Ticket, CircuitBoard} from "lucide-react";
...
import { POWERBI_DASHBOARDS } from "@/config/powerbi.catalog";
...
const STATS: StatItem[] = [
  ...
  { label: "Documentos recientes", value: "94",    sub: "subidos este mes",    icon: TrendingUp,    accent: "emerald", enabled: false },
  ...
  { label: "Tableros EDM",    value: POWERBI_DASHBOARDS.length.toString(),      sub: "Tableros Corporativos",    icon: CircuitBoard,   accent: "fuchsia",  enabled: true },
