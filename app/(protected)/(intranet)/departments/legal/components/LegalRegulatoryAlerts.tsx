...
type RegulatoryProps = { data: LegalData };
...
> = {
  critical: {
    ...
    badge:    "Crítico",
    badgeCls: "bg-red-50 text-red-700 border border-red-200 dark:bg-red-500/[0.10] dark:text-red-400 dark:border-red-500/20",
  },
  warning: {
    Icon:     AlertTriangle,
    ...
    badge:    "Atención",
    badgeCls: "bg-amber-50 text-amber-700 border border-amber-200 dark:bg-amber-500/[0.10] dark:text-amber-400 dark:border-amber-500/20",
  },
  info: {
    Icon:     Info,
    ...
    badge:    "Informativo",
    badgeCls: "bg-sky-50 text-sky-700 border border-sky-200 dark:bg-sky-500/[0.10] dark:text-sky-400 dark:border-sky-500/20",
  },
};
